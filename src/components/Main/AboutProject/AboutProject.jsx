...
export function AboutProject() {
  return (
    <section className="about-project about-project_size_l" id="about-project">
      ...
      <ul className="about-project__timeline-list list">
        <li className="about-project__timeline-element">
          <h3 className="about-project__timeline-title about-project__timeline-title_color_black">1&nbsp;неделя</h3>
