...
export default function useWindowSize() {
  ...
  useLayoutEffect(() => {
    window.addEventListener('resize', slowDown(handleScreenResize, DEBOUNCE_TIME_MS));
    handleScreenResize();
    return () => {
      window.removeEventListener('resize', slowDown(handleScreenResize, DEBOUNCE_TIME_MS));
    };
  })
  return screenType
}
